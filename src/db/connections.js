  ...
  try {
    ...
    models = {
      GLOBAL: {
        ...
        TRANSACTION: require("../schema/transaction/transaction")(connection_IN_HONDA),
        VEHICLESUBCATEGORY: require("../schema/vehicleSubCategory/vehicleSubCategory")(connection_IN_HONDA),
        LICENSECATEGORY: require("../schema/licenseCategory/licenseCategory")(connection_IN_HONDA),
        COURSETYPE: require("../schema/courseType/courseType")(connection_IN_HONDA),
        COURSECATEGORY: require("../schema/courseCategory/courseCategory")(connection_IN_HONDA),
        ...
        STARTCOURSE: require("../schema/startCourse/startCourse")(connection_IN_HONDA),
        IP: require("../schema/ip-authentication/ip")(connection_IN_HONDA),
        ...
        FAQCATEGORY: require("../schema/faqCategory/faqCategory")(connection_IN_HONDA),
        ...
        ASSIGNMENU: require("../schema/AssignMenu/Assignmenu")(connection_IN_HONDA),
        TEST: require("../schema/Test/Test")(connection_IN_HONDA),
        ADMINLOGINLOG: require("../schema/adminLoginLog/adminLoginLog")(connection_IN_HONDA),
        QUESTIONCATEGORY: require("../schema/Question-Category/Question-Category")(connection_IN_HONDA),
        HELPFULTIPS: require("../schema/HelpfulTIps/helpfultips")(connection_IN_HONDA),
        TESTOMONIAL: require("../schema/Testomonial/testomonial")(connection_IN_HONDA),
        ...
        WEBHOOK: require("../schema/webHook/webHook")(mongooseConnections.GLOBAL.HONDA),
      },
    };
