...
module.exports = exports = {
  ...
  handler: async (req, res) => {
    ...
    try {
      let Item = await global.models.GLOBAL.TEST.findById(id);
      ...
      if (!Item) {
        ...
        Item = await global.models.GLOBAL.TEST.findByIdAndUpdate(
          { _id: id },
          { $set: { batch: batch, question: question } }
        );
        const data4createResponseObject = {
          req: req,
          result: 0,
