...
module.exports = exports = {
    ...
    handler: async (req, res) => {
        ...
        try {
            ...
            const checkMenu = await global.models.GLOBAL.QUESTIONSET.find({Aid:Aid,name:name});
            ...
            const newAmeninties = await global.models.GLOBAL.QUESTIONSET(AmenintiesCreate);
            newAmeninties.save();
            const data4createResponseObject = {
                req: req,
                result: 0,
