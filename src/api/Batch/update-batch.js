...
module.exports = exports = {
  ...
  handler: async (req, res) => {
    ...
    try {
      let Item = await global.models.GLOBAL.BATCH.findById(id);
      ...
      if (!Item) {
        ...
        // const checkMenu = await global.models.GLOBAL.CMS.findById(id);
        ...
        Item = await global.models.GLOBAL.BATCH.findByIdAndUpdate(
          { _id: id },
          {
            $set: {
              name: name,
